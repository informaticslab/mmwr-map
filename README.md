...
===========
The goal of this prototype has been to examine existing MMWR content for geovisualization on the iOS iPad platform. This prototype was completed in 2010. The goal of this prototype has been to bring the MMWR (Morbidity and Mortality Weekly Report) to the iPad via a map-based navigation interface. The geographic areas relating to MMWR articles are indicated with pins on a map. There are also a variety of filtering options.

Prototype write-up is available through [PHIResearchLab.org](http://www.phiresearchlab.org/index.php?option=com_content&view=article&id=68:-mmwr-ipad-&catid=1:prototypes&Itemid=3)
